...
def weatherInfo(request):
    ...
    # print(geo_data)
    url = 'https://api.openweathermap.org/data/2.5/weather?lat='+geo_data['latitude']+'&lon='+geo_data['longitude']+'&appid=e11862ae7905f24f99e779d8ffeed6c1'
